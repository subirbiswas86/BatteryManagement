...
#define GETVOLT		00 //<get battery voltage
#define GETSERISR	01 //<get series resistance
#define GETLOADR	02 //<get load resistance
#define GETINITV	03 //<get battery initial voltage
...
#define SETINTV		103 //<set initial voltage <v1> <v2> <v3>

#define SIMSTART	205 //<simulation start
#define SIMSTOP		206 //<simulation stop
